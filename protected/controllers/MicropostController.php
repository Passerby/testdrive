...
class MicropostController extends Controller
{
    ...
    {
        $model=new Micropost('search');
        $model->unsetAttributes();  // clear any default values
        if(isset($_GET['Micropost']))
            $model->attributes=$_GET['Micropost'];
     ...
     * @return Micropost the loaded model
    ...
    {
        $micropost=Micropost::model()->findByPk(1);
        $user=$micropost->user;
    ...
    {
        $micropost=Micropost::model()->with('user')->findByPk(1);
        CVarDumper::dump($micropost->user,10,true);
    }
    /**
